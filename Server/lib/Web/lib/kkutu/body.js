...
function addonNickname($R, o){
	...
	if(o.equip['NIK']) $R.addClass("x-" + o.equip['NIK']);
	if(o.equip['BDG'] == "gm") $R.addClass("x-gm1");
	if(o.equip['NIK']) $R.addClass("x-" + o.equip['NIK']);
	if(o.equip['BDG'] == "word") $R.addClass("x-word");
	if(o.equip['NIK']) $R.addClass("x-" + o.equip['NIK']);
	if(o.equip['BDG'] == "hongbo") $R.addClass("x-hongbo");
	if(o.equip['BDG'] == "streamer") $R.addClass("x-streamer");
	if(o.equip['BDG'] == "garu") $R.addClass("x-garu");
	if(o.equip['BDG'] == "mg") $R.addClass("x-mg");
	if(o.equip['BDG'] == "donate") $R.addClass("x-donate");
}
